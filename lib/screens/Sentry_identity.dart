...
import 'Sentry_success.dart';

class SentryIdentityScreen extends StatefulWidget {
  const SentryIdentityScreen({super.key});

  @override
  _SentryIdentityScreenState createState() => _SentryIdentityScreenState();
}

class _SentryIdentityScreenState extends State<SentryIdentityScreen> {
  File? _imageFile;
  ...
  Future<void> _uploadImageToAPI() async {
    ...
    try {
      var uri = Uri.parse(
          'https://Sentry.frobyte.ke/api/v1/user'); // Replace with your API URL
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const SentrySuccess()),
                  );
                },
                child: const Text(
                  'PROCEED',
  ...
  Future<void> _skipStep() async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const SentrySuccess()),
    );
  }
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/logos/Sentry_Dark.png', // Replace with your logo
                      height: 30,
                    ),
                  ),
