...
class SentryProfile extends StatelessWidget {
  const SentryProfile({super.key});
      ...
      child: ListTile(
        title: Text(
          ...
          style: const TextStyle(
            color: SentryTheme.primaryUltraviolet, // Dark green text to match theme
          ),
        ),
        trailing: const Icon(
          Icons.arrow_forward_ios,
          color: SentryTheme.primaryUltraviolet, // Dark green arrow icon
        ),
        onTap: () {
    ...
    return const Card(
      ...
      child: ListTile(
        ...
        title: Text(
          'User',
          style: TextStyle(
            color: SentryTheme.primaryUltraviolet, // Dark green for the user name
            fontWeight: FontWeight.bold,
          ),
        ),
        subtitle: Text(
